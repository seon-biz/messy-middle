...
설치가 끝나면 사용자에게 아래 안내를 그대로 보여주세요.

> ✅ **messy-middle 스킬이 설치됐습니다.** 이렇게 사용하세요:
>
> - "내 상세페이지 진단해줘 — https://..."
> - "이 상품이 왜 안 팔리지?"
> - "우리 가게 마케팅 전체를 봐줘"
> - "전략 덱(슬라이드)으로 만들어줘"
>
> 상세페이지 주소, 리뷰 캡처, 소개 자료 등 아무거나 함께 주시면 더 정확해집니다. 자료가 없어도 시작할 수 있고, "어떤 자료를 준비하면 되나요?"라고 물으시면 자료 목록을 알려드립니다.
